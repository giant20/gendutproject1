		...
		<form  method="post" id="contoh" action="daftar/index" enctype="multipart/form-data">
			<div class="bag">
				...
				<div class="form_row_konten">
					...
					<input type="text" name="title" id="title" class="konten" value="<?php echo $query->title; ?>" />
				</div> 
				
				<?php echo form_error('konten', '<br /><div class="error">', '</div>'); ?>
				<div class="form_row_konten">
					<label class="field_konten">Konten:</label>
					<textarea name="konten" id="konten" class="konten" value=""><?php echo $query->konten; ?></textarea>
				</div> 
				
				
			<div class="tombol_bawah">
				<a href="<?php echo site_url('backend/konten/hal')?>"><button class="submit" >Batal</button></a>
