...
<table width="371" border="0">
  ...
  <tr>
    ...
    <td><?php echo form_error('nilai_huruf'); ?>
      <input type="text" name="nilai_huruf" id="nilai_huruf" value="<?php echo $row->nilai_huruf;?>" /></td>
  </tr>
    <tr>
    <td>Nilai Angka</td>
    <td>:</td>
    <td><?php echo form_error('nilai_angka'); ?>
      <input type="text" name="nilai_angka" id="nilai_angka" value="<?php echo $row->nilai_angka;?>" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
