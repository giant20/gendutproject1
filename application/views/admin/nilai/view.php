...
<tr class="<?php if ($no %2 == 0) echo 'zebra';?>">
	...
	<td><a href="<?php echo base_url().'admin/nilai/edit/'.$row['id_kuliah'].'/'.$nama->id_mahasiswa;?>">Edit</a>|
	<a href="<?php echo base_url().'admin/nilai/delete/'.$row['id_kuliah'].'/'.$nama->id_mahasiswa;?>">Delete</a> </td></tr>
	<?php $no++;}?>
	</table>